...
import { ClusterInfo, SecretProviderClass } from '@aws-quickstart/eks-blueprints';
import { ClusterAddOn } from '@aws-quickstart/eks-blueprints/dist/spi/addon-contracts';
...
export class FluxV2Addon implements ClusterAddOn {
  ...
  private createIRSA(cluster: eks.Cluster): eks.ServiceAccount {
    ...
    return createServiceAccount(cluster, 'flux-system-git-sa', 'flux-system', sourceControllerPolicy);
  }
}
