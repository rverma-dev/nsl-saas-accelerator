...
//   private _resourceSets: Map<
//     Route53ApplicationRecoveryControllerResourceSetType,
//     Route53ApplicationRecoveryControllerResourceProps[]
//   >;
...
//   public addResource(
//     resourceType: Route53ApplicationRecoveryControllerResourceSetType,
//     resourceProps: Route53ApplicationRecoveryControllerResourceProps,
//   ): Route53ApplicationRecoveryController {
//     if (!this._resourceSets) {
//       this._resourceSets = new Map<
//         Route53ApplicationRecoveryControllerResourceSetType,
//         Route53ApplicationRecoveryControllerResourceProps[]
//       >();
//     }
...
//       const resourcesProperty: rr.CfnResourceSet.ResourceProperty[] = [];
//       resources.forEach(resource => {
//         resourcesProperty.push({
//           resourceArn: resource.resourceArn,
//           readinessScopes: [cells.find(cell => cell.cellName === resource.cellScopeName)!.attrCellArn],
//         });
//       });
//       const resourceSetName = `${resourceSetType.split('::').slice(-1)}s`;

//       const newResourceSet = new rr.CfnResourceSet(this, `ResourceSet${resourceSetName}`, {
//         resourceSetName: resourceSetName,
//         resourceSetType: resourceSetType,
//         resources: resourcesProperty,
//       });

//       const newReadinessCheck = new rr.CfnReadinessCheck(this, `${resourceSetName}ReadinessCheck`, {
...
//       const routingControl = new rc.CfnRoutingControl(this, `${cell.cellName}RoutingControl`, {
//         name: `${this.controlPanel.name}-${cell.cellName}`,
//         clusterArn: this.cluster.attrClusterArn,
//         controlPanelArn: this.controlPanel.attrControlPanelArn,
//       });

//       const healthCheck = new r53.CfnHealthCheck(this, `${cell.cellName}HealthCheck`, {
//         healthCheckConfig: {
