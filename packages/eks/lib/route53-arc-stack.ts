// import { CfnParameter, Names, Stack, StackProps } from 'aws-cdk-lib';
...
//     const cellScopeName = `${this.r53arc.cluster.name}-${region}`;

//     const cellClusterVPC = new CfnParameter(this, `${region}VPC`, {
//       type: 'String',
//       description: `VPC ARN on ${region}`,
//     });

//     const cellClusterASG = new CfnParameter(this, `${region}ASG`, {
//       type: 'String',
//       description: `ASG ARN for EKS cluster on ${region}`,
//     });

//     const cellClusterALB = new CfnParameter(this, `${region}ALB`, {
//       type: 'String',
